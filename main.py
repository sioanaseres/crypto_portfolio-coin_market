...
# cursorObj.execute('INSERT INTO coin VALUES(2, "SOL", 2, 3500)')
# con.commit()
...
def my_portfolio():
    api_request = requests.get("https://pro-api.coinmarketcap.com/v1/cryptocurrency/listings/latest?start=1&limit=5&convert=USD&CMC_PRO_API_KEY=59d0e3d4-1650-4a4b-aaa3-0469f2390f65")
    ...
    for i in range(0,5):
      for coin in coins:
        if api["data"][i]["symbol"] == coin[1]:
          ...
          portfolio_id = Label(pycrypto, text=coin[0], bg="grey", fg="black" , font="Lato 12 bold", padx="2", pady="2", borderwidth=2, relief="groove")
          ...
          no_coins = Label(pycrypto, text=coin[2], bg="grey", fg="black" , font="Lato 12 bold", padx="2", pady="2", borderwidth=2, relief="groove")
          ...
          pl_coin = Label(pycrypto, text="${0:.2f}".format(pl_percoin), bg="white", fg=font_color(float("{0:.2f}".format(pl_percoin))) , font="Lato 12 bold", padx="2", pady="2", borderwidth=2, relief="groove")
          pl_coin.grid(row=coin_row, column=6 , sticky=N+S+E+W)

          totalpl = Label(pycrypto, text="${0:.2f}".format(total_pl_coin), bg="grey", fg=font_color(float("{0:.2f}".format(total_pl_coin))) , font="Lato 12 bold", padx="2", pady="2", borderwidth=2, relief="groove")
   ...
   # Insert data
    ...
    add_coin = Button(pycrypto, text="Add Coin", bg="blue", fg="white" , command=insert_coin,  font="Lato 12 bold", padx="2", pady="2", borderwidth=2, relief="groove")
    ...
    update_coin = Button(pycrypto, text="Update Coin", bg="blue", fg="white" , command=update_coin,  font="Lato 12 bold", padx="2", pady="2", borderwidth=2, relief="groove")
    ...
    delete_coin = Button(pycrypto, text="Delete Coin", bg="blue", fg="white" , command=delete_coin,  font="Lato 12 bold", padx="2", pady="2", borderwidth=2, relief="groove")
    delete_coin.grid(row=coin_row+3, column=4 , sticky=N+S+E+W)
    
    totalap = Label(pycrypto, text="${0:.2f}".format(total_amount_paid), bg="grey", fg="black" , font="Lato 12 bold", padx="2", pady="2", borderwidth=2, relief="groove")
    totalap.grid(row=coin_row, column=4 , sticky=N+S+E+W)
    
    totalcv = Label(pycrypto, text="${0:.2f}".format(total_current_value), bg="grey", fg="black" , font="Lato 12 bold", padx="2", pady="2", borderwidth=2, relief="groove")
    totalcv.grid(row=coin_row, column=5 , sticky=N+S+E+W)
    
    totalpl = Label(pycrypto, text="${0:.2f}".format(total_pl), bg="grey", fg="black" , font="Lato 12 bold", padx="2", pady="2", borderwidth=2, relief="groove")
    totalpl.grid(row=coin_row, column=7 , sticky=N+S+E+W)
    
    api = " "
    refresh = Button(pycrypto, text="Refresh", bg="blue", fg="white" , command=reset,  font="Lato 12 bold", padx="2", pady="2", borderwidth=2, relief="groove")
    refresh.grid(row=coin_row+1, column=7 , sticky=N+S+E+W)
    
def app_header():

    portfolio_id = Label(pycrypto, text="Portofolio Id", bg="blue", fg="black", font="Lato 12 bold", padx="5", pady="5",borderwidth=2, relief="groove")
    portfolio_id.grid(row=0, column=0 , sticky=N+S+E+W)
    
    name = Label(pycrypto, text="Coin Name", bg="blue", fg="black", font="Lato 12 bold", padx="5", pady="5",borderwidth=2, relief="groove")
    name.grid(row=0, column=1 , sticky=N+S+E+W)

    price = Label(pycrypto, text="Price", bg="blue", fg="black", font="Lato 12 bold", padx="5", pady="5", borderwidth=2, relief="groove")
    price.grid(row=0, column=2 , sticky=N+S+E+W)

    no_coins = Label(pycrypto, text="Coin Owned", bg="blue", fg="black"  , font="Lato 12 bold", padx="5", pady="5", borderwidth=2, relief="groove")
    no_coins.grid(row=0, column=3 , sticky=N+S+E+W)

    amount_paid = Label(pycrypto, text="Total Amount Paid", bg="blue", fg="black" , font="Lato 12 bold", padx="5", pady="5", borderwidth=2, relief="groove")
    amount_paid .grid(row=0, column=4 , sticky=N+S+E+W)

    current_val = Label(pycrypto, text="Current Value", bg="blue", fg="black" , font="Lato 12 bold", padx="5", pady="5", borderwidth=2, relief="groove")
    current_val.grid(row=0, column=5, sticky=N+S+E+W)

    pl_coin = Label(pycrypto, text="P/L Per Coin", bg="blue", fg="black" , font="Lato 12 bold", padx="5", pady="5", borderwidth=2, relief="groove")
    pl_coin.grid(row=0, column=6 , sticky=N+S+E+W)

    totalpl = Label(pycrypto, text="Total P/L with coin", bg="blue", fg="black")
